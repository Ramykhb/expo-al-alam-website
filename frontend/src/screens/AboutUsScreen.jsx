    ...
    <div className="w-full min-h-screen relative overflow-x-hidden bg-[#080808]">
      ...
      <div className="relative z-10">
        ...
        >
          ...
          <div className="relative z-10 w-full flex justify-between items-center">
            <div className="max-w-4xl">
              ...
              <div className="flex items-center gap-6 mt-10 opacity-0 animate-[slideRightFade_0.8s_ease-out_0.6s_forwards]">
                ...
                <p className="text-zinc-500 font-sans uppercase tracking-widest text-[10px] font-bold">
                  Beyond Engineering // Beyond Imagination
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="h-full flex flex-col justify-between italic">
                <span className="text-[#64748b] text-4xl font-black">01</span>
                <div>
                  <h4 className="text-white text-xl font-bold uppercase mb-2">
                    Curated Power
                  </h4>
                  <p className="text-zinc-400 text-xs font-sans leading-relaxed">
                    A selection of the world's rarest machinery, brought
                    together for a singular three-day event in the heart of the
                    world.
                  </p>
                </div>
              </div>
          ...
          <div
            className="absolute bottom-0 right-0 w-[70%] h-[80%] opacity-20 pointer-events-none grayscale contrast-125"
            style={{
              backgroundImage:
        ...
        <section className="px-20 grid md:grid-cols-2 gap-20 items-center py-20 overflow-hidden">
          ...
          >
            ...
            <p className="text-zinc-400 text-lg leading-relaxed font-sans w-[90%]">
              Expo Al Alam was founded on a simple premise: velocity is an art
              form. We don't just showcase cars; we exhibit the peak of human
              ambition, wrapped in carbon fiber and aluminum.
            </p>
            <p className="text-zinc-500 text-md font-sans italic">
              "To define the road, one must first imagine it doesn't exist."
            </p>
          </motion.div>
